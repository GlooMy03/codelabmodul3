...
class CreateTaskScreen extends StatefulWidget {
  ...
  const CreateTaskScreen({ // Added const constructor
...
class _CreateTaskScreenState extends State<CreateTaskScreen> {
  ...
  late double widthScreen; // Changed to late
  late double heightScreen; // Changed to late
  late DateTime date; // Changed to late
  bool isLoading = false;

  @override
  void initState() {
    super.initState();
    date = DateTime.now().add(const Duration(days: 1)); // Added const
